...
public class MainActivity extends AppCompatActivity {
    ...
    private final PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        @Override
        public void onCodeSent(@NonNull String s, @NotNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {

            dialog.dismiss();
            login.setTextColor(Color.parseColor("#000000"));
            otpsent.setText("OTP has been sent your mobile number");
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            ...
            getotpclicked = false;
            getotp.setTextColor(Color.parseColor("#D81B60"));
